export const required = (value) => { console.log('----------------', value); return value ? undefined : 'is Required!'; };
...
export const email = (value) => { return value && !/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i.test(value) ? 'invalid email' : undefined; };
